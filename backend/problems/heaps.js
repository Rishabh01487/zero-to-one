export default [
  {
    ...
    mermaid: "flowchart TD\n  A[\"Kth Largest Element in a Stream\"] --> B[\"Init heap\"]\n  B --> C{\"More elements?\"}\n  C -->|Yes| D[\"Push element\"]\n  D --> E[\"Pop if needed\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log k)","space":"O(k)"},
    mermaid: "flowchart TD\n  A[\"Merge K Sorted Arrays\"] --> B[\"Init heap\"]\n  B --> C{\"More elements?\"}\n  C -->|Yes| D[\"Push element\"]\n  D --> E[\"Pop if needed\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Top K Frequent Elements\"] --> B[\"Init hash map\"]\n  B --> C{\"More elements?\"}\n  C -->|Yes| D[\"Compute key\"]\n  D --> E{\"Exists?\"}\n  E -->|Yes| F[\"Update result\"]\n  E -->|No| G[\"Store in map\"]\n  F --> C\n  G --> C\n  C -->|No| H[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Find Median from Data Stream\"] --> B[\"Init heap\"]\n  B --> C{\"More elements?\"}\n  C -->|Yes| D[\"Push element\"]\n  D --> E[\"Pop if needed\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log k)","space":"O(k)"},
    mermaid: "flowchart TD\n  A[\"K Closest Points to Origin\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log k)","space":"O(k)"},
    mermaid: "flowchart TD\n  A[\"Kth Smallest Element\"] --> B[\"Init heap\"]\n  B --> C{\"More elements?\"}\n  C -->|Yes| D[\"Push element\"]\n  D --> E[\"Pop if needed\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Connect Ropes with Minimum Cost\"] --> B[\"Sort/order input\"]\n  B --> C[\"Init result=0\"]\n  C --> D{\"All processed?\"}\n  D -->|No| E[\"Make greedy choice\"]\n  E --> F[\"Update result\"]\n  F --> D\n  D -->|Yes| G[\"Return result\"]",
    sheet: "GeeksforGeeks",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log k)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Top K Frequent Words\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Find K Pairs with Smallest Sums\"] --> B[\"Init heap\"]\n  B --> C{\"More elements?\"}\n  C -->|Yes| D[\"Push element\"]\n  D --> E[\"Pop if needed\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Reorganize String\"] --> B[\"Sort/order input\"]\n  B --> C[\"Init result=0\"]\n  C --> D{\"All processed?\"}\n  D -->|No| E[\"Make greedy choice\"]\n  E --> F[\"Update result\"]\n  F --> D\n  D -->|Yes| G[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Rearrange String K Distance Apart\"] --> B[\"Sort/order input\"]\n  B --> C[\"Init result=0\"]\n  C --> D{\"All processed?\"}\n  D -->|No| E[\"Make greedy choice\"]\n  E --> F[\"Update result\"]\n  F --> D\n  D -->|Yes| G[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Least Interval (Task Scheduler II)\"] --> B[\"Sort/order input\"]\n  B --> C[\"Init result=0\"]\n  C --> D{\"All processed?\"}\n  D -->|No| E[\"Make greedy choice\"]\n  E --> F[\"Update result\"]\n  F --> D\n  D -->|Yes| G[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Sort Features by Frequency\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "GeeksforGeeks",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Farthest Building You Can Reach\"] --> B[\"Sort/order input\"]\n  B --> C[\"Init result=0\"]\n  C --> D{\"All processed?\"}\n  D -->|No| E[\"Make greedy choice\"]\n  E --> F[\"Update result\"]\n  F --> D\n  D -->|Yes| G[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Minimum Number of Refueling Stops\"] --> B[\"Sort/order input\"]\n  B --> C[\"Init result=0\"]\n  C --> D{\"All processed?\"}\n  D -->|No| E[\"Make greedy choice\"]\n  E --> F[\"Update result\"]\n  F --> D\n  D -->|Yes| G[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Swim in Rising Water\"] --> B[\"Init visited\"]\n  B --> C[\"BFS or DFS\"]\n  C --> D[\"Start from source\"]\n  D --> E[\"Visit neighbors\"]\n  E --> F{\"Visited?\"}\n  F -->|No| G[\"Mark + enqueue\"]\n  F -->|Yes| H[\"Skip\"]\n  G --> I{\"More?\"}\n  H --> I\n  I -->|Yes| E\n  I -->|No| J[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Minimum Cost to Connect All Points\"] --> B[\"Init visited\"]\n  B --> C[\"BFS or DFS\"]\n  C --> D[\"Start from source\"]\n  D --> E[\"Visit neighbors\"]\n  E --> F{\"Visited?\"}\n  F -->|No| G[\"Mark + enqueue\"]\n  F -->|Yes| H[\"Skip\"]\n  G --> I{\"More?\"}\n  H --> I\n  I -->|Yes| E\n  I -->|No| J[\"Return result\"]",
    sheet: "LeetCode",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Shortest Path using Dijkstra (Heap)\"] --> B[\"Init visited\"]\n  B --> C[\"BFS or DFS\"]\n  C --> D[\"Start from source\"]\n  D --> E[\"Visit neighbors\"]\n  E --> F{\"Visited?\"}\n  F -->|No| G[\"Mark + enqueue\"]\n  F -->|Yes| H[\"Skip\"]\n  G --> I{\"More?\"}\n  H --> I\n  I -->|Yes| E\n  I -->|No| J[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log k)","space":"O(k)"},
    mermaid: "flowchart TD\n  A[\"Kth Largest Element in an Array\"] --> B[\"Init heap\"]\n  B --> C{\"More elements?\"}\n  C -->|Yes| D[\"Push element\"]\n  D --> E[\"Pop if needed\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
