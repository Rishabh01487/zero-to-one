export default [
  {
    ...
    mermaid: "flowchart TD\n  A[\"Bubble Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Selection Sort\"] --> B[\"Find min in unsorted\"]\n  B --> C[\"Swap with first unsorted\"]\n  C --> D[\"Move boundary\"]\n  D --> E{\"More elements?\"}\n  E -->|Yes| B\n  E -->|No| F[\"Return sorted\"]",
    techniques: ["sorting"],
  },
  {
    id: "insertion-sort",
    ...
    mermaid: "flowchart TD\n  A[\"Insertion Sort\"] --> B[\"Pick element\"]\n  B --> C[\"Shift sorted to right\"]\n  C --> D[\"Insert at correct position\"]\n  D --> E{\"More elements?\"}\n  E -->|Yes| B\n  E -->|No| F[\"Return sorted\"]",
    techniques: ["sorting"],
  },
  {
    id: "merge-sort-prob",
    ...
    mermaid: "flowchart TD\n  A[\"Merge Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Quick Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Count Inversions (Merge Sort)\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Heap Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Kth Smallest Element (QuickSelect)\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Radix Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Timsort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Comb Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n²)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Pancake Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n²)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Gnome Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Stooge Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n²)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Cocktail Shaker Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Pigeonhole Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n²)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Cycle Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n²)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Odd-Even Sort / Brick Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Introsort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n log n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Patience Sort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Smoothsort Implementation\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n) avg, O(n²) worst","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"QuickSelect: Kth Largest/Smallest\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
    solution_code: "int quickSelect(int arr[],int l,int r,int k){int pi=partition(arr,l,r);if(k==pi)return arr[k];return(k<pi)?quickSelect(arr,l,pi-1,k):quickSelect(arr,pi+1,r,k);}",
    techniques: ["sorting"],
  },
  {
    ...
    complexity: {"time":"O(n log n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"External Sorting (Merge Sort for Large Data)\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Bucket Sort for Floating Point Numbers\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Radix Sort for Strings\"] --> B[\"Choose pivot/split\"]\n  B --> C[\"Partition elements\"]\n  C --> D[\"Recursively sort\"]\n  D --> E[\"Merge/combine\"]\n  E --> F[\"Return sorted\"]",
    sheet: "Striver A2Z",
