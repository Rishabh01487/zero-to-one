export default [
  {
    ...
    mermaid: "flowchart TD\n  A[\"Min Stack\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Next Greater Element\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Queue Using Stacks\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Stock Span Problem\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Largest Rectangle in Histogram\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"The Celebrity Problem\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Infix to Postfix Conversion\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Stack Using Queues\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Max Rectangle in Binary Matrix\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Daily Temperatures\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Next Smaller Element\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Previous Greater Element\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Previous Smaller Element\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Remove K Digits\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Decode String\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Simplify Path\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Evaluate Reverse Polish Notation\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Basic Calculator II\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Minimum Remove to Make Valid Parentheses\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Remove Duplicate Letters\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Asteroid Collision\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Validate Stack Sequences\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Car Fleet\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Exclusive Time of Functions\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(1) each","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Maximum Frequency Stack\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(1) amortized","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Online Stock Span\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"LRU Cache\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    complexity: {"time":"O(1) each","space":"O(capacity)"},
    mermaid: "flowchart TD\n  A[\"LFU Cache\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Striver A2Z",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Largest Rectangle in Histogram (Alternate)\"] --> B[\"Init empty stack\"]\n  B --> C{\"For each element\"}\n  C -->|Yes| D{\"Stack && condition?\"}\n  D -->|Yes| E[\"Pop, record result\"]\n  D -->|No| F[\"Push current\"]\n  E --> D\n  F --> C\n  C -->|No| G[\"Return results\"]",
    sheet: "Love Babbar 450",
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Max Sliding Window (Heap Approach)\"] --> B[\"left=0, right=0\"]\n  B --> C{\"right < n?\"}\n  C -->|Yes| D[\"Expand: add arr[right]\"]\n  D --> E{\"Window valid?\"}\n  E -->|No| F[\"right++\"]\n  E -->|Yes| G[\"Update answer\"]\n  G --> H[\"Shrink: left++, remove arr[left]\"]\n  H --> E\n  F --> C\n  C -->|No| I[\"Return answer\"]",
    sheet: "Love Babbar 450",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Postfix Expression Evaluation\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Prefix Expression Evaluation\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Balanced Parentheses Check\"] --> B[\"Init stack/queue\"]\n  B --> C{\"More operations?\"}\n  C -->|Yes| D[\"Push/enqueue or pop/dequeue\"]\n  D --> E[\"Check peek/front\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
  ...
  },
  {
    ...
    complexity: {"time":"O(n^2)","space":"O(n)"},
    mermaid: "flowchart TD\n  A[\"Reverse a Stack Using Recursion\"] --> B[\"Define base case\"]\n  B --> C{\"Base?\"}\n  C -->|Yes| D[\"Return base value\"]\n  C -->|No| E[\"Recurse smaller\"]\n  E --> F[\"Combine results\"]\n  F --> G[\"Return\"]",
    sheet: "Love Babbar 450",
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"First Non-Repeating Character in Stream\"] --> B[\"Init queue with root\"]\n  B --> C{\"Queue empty?\"}\n  C -->|No| D[\"Pop node from queue\"]\n  D --> E[\"Process current node\"]\n  E --> F[\"Push left child\"]\n  F --> G[\"Push right child\"]\n  G --> C\n  C -->|Yes| H[\"Return result\"]",
    sheet: "Striver A2Z",
