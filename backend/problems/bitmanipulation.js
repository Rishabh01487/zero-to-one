export default [
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Power of Two\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Count Set Bits (Brian Kernighan)\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Power Set using Bits\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Find Most Significant Bit\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Swap Two Bits\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "Love Babbar 450",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Reverse Bits\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 190",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Hamming Distance\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 461",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Sum of Two Integers (No +/-)\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 371",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Single Number II (Thrice)\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 137",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Single Number III (Two Singles)\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 260",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Gray Code Sequence\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 89",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Missing Number (Bitwise)\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 268",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Range Bitwise AND\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 201",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Power of Four\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 342",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Maximum XOR of Two Numbers\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 421",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"XOR Queries of Subarray\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 1310",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    mermaid: "flowchart TD\n  A[\"Count Triplets with XOR Zero\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 1442",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Total Hamming Distance\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 477",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Complement of Base 10 Integer\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 1009",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Binary Watch\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 401",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(log n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Number Complement\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 476",
    techniques: ["bit-manipulation"],
    solution_code: "int mask = n;\nmask |= mask >> 1; mask |= mask >> 2; mask |= mask >> 4; mask |= mask >> 8; mask |= mask >> 16;\ncout << (n ^ mask);",
    solution_template: "#include <iostream>\nusing namespace std;\n\nint main() {\n  int n; cin >> n;\n  // complement\n  return 0;\n}",
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Has Alternating Bits\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 693",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Binary Prefix Divisible by 5\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 1018",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(1)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Minimum Flips for A OR B = C\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 1318",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"XOR Operation in Array\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 1486",
    techniques: ["bit-manipulation"],
  ...
  },
  {
    ...
    complexity: {"time":"O(log n)","space":"O(1)"},
    mermaid: "flowchart TD\n  A[\"Bitwise AND of Numbers Range (Alternate)\"] --> B[\"Init result=0\"]\n  B --> C{\"For each bit\"}\n  C -->|Yes| D[\"Apply bit op\"]\n  D --> E[\"Update result\"]\n  E --> C\n  C -->|No| F[\"Return result\"]",
    sheet: "LeetCode 201",
    techniques: ["bit-manipulation"],
